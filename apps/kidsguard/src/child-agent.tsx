  ...
  const setupSteps: SetupStep[] = [
    {
      ...
      hint: "Si Gospion est grisé : touche ⋮ en haut → « Autoriser les paramètres restreints », puis active-le.",
      ok: accessOk,
    ...
    },
    {
      ...
      desc: "Pour que le téléphone n'éteigne pas Gospion en arrière-plan.",
    ...
    },
    {
      ...
      desc: "Empêche la désinstallation de Gospion par l'enfant.",
      ok: adminOk,
      ...
      ? [
          {
            ...
            desc: "Indispensable sur ce téléphone : sans ça, le système coupe Gospion et la localisation s'arrête.",
            hint: "Active Gospion dans la liste « Démarrage auto » qui s'ouvre, puis reviens et touche « J'ai activé ».",
            ok: autostartOk,
