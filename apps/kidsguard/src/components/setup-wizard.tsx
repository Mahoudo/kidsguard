...
const s = StyleSheet.create({
  c: { padding: 22, paddingTop: 56, alignItems: "center", backgroundColor: "#FFF6EC", minHeight: "100%" },
  mascot: { fontSize: 52 },
  ...
  barFill: { height: "100%", backgroundColor: "#21C97A", borderRadius: 999 },
  count: { fontSize: 13, fontWeight: "700", color: "#6C5CE7", marginTop: 8, marginBottom: 14 },
  card: {
    width: "100%", backgroundColor: "#fff", borderRadius: 16, padding: 16, marginBottom: 12,
    borderWidth: 1, borderColor: "#eee",
  },
  cardOk: { borderColor: "#21C97A55", backgroundColor: "#F2FCF6" },
  ...
  btn: { backgroundColor: "#6C5CE7", borderRadius: 999, paddingVertical: 11, alignItems: "center", marginTop: 12 },
  btnTxt: { color: "#fff", fontWeight: "800", fontSize: 14 },
  recheck: { marginTop: 8, padding: 12 },
  recheckTxt: { color: "#6C5CE7", fontWeight: "700", fontSize: 14 },
  doneNote: { fontSize: 15, color: "#21C97A", fontWeight: "700", marginTop: 8, marginBottom: 30 },
